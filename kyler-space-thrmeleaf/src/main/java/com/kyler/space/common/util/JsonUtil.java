...
//	}
    ...
    public static <T> T fromJson(String json, TypeReference<?> typeReference, Inclusion inclusion) throws IOException {
        return (T) (typeReference.getType().equals(String.class) ? json : generateMapper(inclusion).readValue(json, typeReference));
    }
}
